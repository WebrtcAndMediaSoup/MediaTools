...
BEGIN_MESSAGE_MAP(CSpecialAAACApp, CWinApp)
...
CSpecialAAACApp::CSpecialAAACApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CSpecialAAACApp 对象

CSpecialAAACApp theApp;


// CSpecialAAACApp 初始化

BOOL CSpecialAAACApp::InitInstance()
{
...
void CSpecialAAACApp::LoadLaguage()
{
	//配置文件路径
